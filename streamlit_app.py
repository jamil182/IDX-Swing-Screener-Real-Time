...
# Fungsi Kirim Telegram (Sudah disesuaikan dengan Secret Anda)
def send_telegram_msg(message):
    try:
        # Menyamakan dengan key di screenshot Anda: TELEGRAM_TOKEN
        ...
        st.error(f"Error Telegram: {e}. Pastikan key di Secrets adalah TELEGRAM_TOKEN dan TELEGRAM_CHAT_ID")
...
# List Saham (Bisa Anda tambah sesuai kebutuhan)
        ...
        try:
            ...
            if is_uptrend and rsi >= rsi_min and vol_ratio >= vol_ratio_min and pct_1m >= pct_1m_min:
                ...
                if mcap >= mcap_min:
                    ...
                    if risk_per_sh / price < 0.02: # Minimal SL 2%
                        sl_price = price * 0.95
                        risk_per_sh = price - sl_price
